Feature: A project is able to have several activities
  ...
  Scenario: Add activity to planner
    And there is an activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and a given ID
    When the activity is added to the planner
    Then the activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and same ID is in the planner

  Scenario: Change information of activity in planner
    And there is an activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and a given ID
    And the activity is added to the planner
    And the activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and same ID is in the planner
    When the project manager changes the planner-activity's to "Roadtrip", description "Event for senior employees", start date "07-09-20", end date "10-09-20", time usage 0.0
    Then the activity with name "Roadtrip", description "Event for senior employees", start date "07-09-20", end date "10-09-20", time usage 0.0 and same ID is in the planner
  ...
  Scenario: Change information of activity in project
    Given there is an activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and a given ID
    And the activity is added to the project
    And the activity with name "ActivityName", description "An activity", start date "06-05-20", end date "01-06-20", time usage 11.5 and same ID is in the project
    When the project manager changes the project-activity's name to "Roadtrip", description "Event for senior employees", start date "07-09-20", end date "10-09-20", time usage 0.0
    Then the activity with name "Roadtrip", description "Event for senior employees", start date "07-09-20", end date "10-09-20", time usage 0.0 and same ID is in the project
